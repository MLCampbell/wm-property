...
mediaQueryLg.addEventListener("change", ()=>{
    if (mediaQueryLg.matches) // console.log('Screen now larger than 1150 px, adding lgScrollFunction');
...
function sendEmail() {
    ...
    let finalMessage = `New Enquiry<br><br>
    Name: ${name}<br>
    Email: ${email}<br>
    ...
    Email.send({
        ...
        if (message === "OK") // console.log("Success behaviour");
        submitSuccess();
        else {
